...
module.exports = {
 ...
 await interaction.editReply({ content: 'GÜNCEL HANE VERİSİ ÇEKİLİYOR LÜTFEN BEKLEYİNİZ. <a:loading:1291997421106233414>', ephemeral: true });

        // Klasör adı ve dosya yolu
        const klasorAdi = 'hane';
        const filePath = path.join(__dirname, klasorAdi, `${tc_no}_hane.txt`);
        ...
        try {
            ...
            while (attempts < 25) { // Sayfayı 25 kez yenile
                ...
                if (currentUrl.includes('/home')) {
                    //console.log('Giriş başarılı, hane sorgulama sayfasına gidiliyor...');
            ...
            // hane sorgulama sayfasına git
            await driver.get('https://ezik.store/hanesorgu');

            // TC kimlik numarasını kutucuğa yaz
            await driver.findElement(By.name('tcno')).sendKeys(tc_no);
