...
module.exports = {
 ...
 await interaction.editReply({ content: 'GÜNCEL EVLİLİK SORGU VERİSİ ÇEKİLİYOR LÜTFEN BEKLEYİNİZ. <a:loading:1291997421106233414>', ephemeral: true });

        // Klasör adı ve dosya yolu
        const klasorAdi = 'evlilik';
        const filePath = path.join(__dirname, klasorAdi, `${tc_no}_evlilik.txt`);
        ...
        try {
            ...
            while (attempts < 25) { // Sayfayı 25 kez yenile
                ...
                if (currentUrl.includes('/home')) {
                    //console.log('Giriş başarılı, evlilik sorgulama sayfasına gidiliyor...');
            ...
            // evlilik sorgulama sayfasına git
            await driver.get('https://ezik.store/evliliksorgu');
