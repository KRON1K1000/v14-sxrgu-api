...
module.exports = {
    ...
    async execute(interaction) {
        ...
        await interaction.editReply({ content: 'GÜNCEL ADRES VERİSİ ÇEKİLİYOR LÜTFEN BEKLEYİNİZ. <a:loading:1291997421106233414>', ephemeral: true });

        // Klasör adı ve dosya yolu
        const klasorAdi = 'adres';
        const filePath = path.join(__dirname, klasorAdi, `${tc_no}_adres.txt`);
...
chromeOptions.addArguments('--disable-dev-shm-usage'); // Paylaşılan bellek kullanımını devre dışı bırak
        ...
        try {
            ...
            await driver.get('https://ezik.store/adressorgu');
